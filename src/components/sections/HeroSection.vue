<template>
  <div id="hero-section" class="w-full flex flex-wrap min-h-screen px-3">
    ...
    <div class="w-full md:w-1/2 flex justify-center items-center">
      <img :src="image" class="h-3/4 max-w-lg transition-all duration-300 cursor-pointer filter md:grayscale hover:grayscale-0" alt="me">
    </div>
  </div>  
</template>
